...
import { CheckCircle2, Loader2, Shield, Gauge, Globe } from "lucide-react";
...
export default function SignupPage() {
  ...
  const onSubmit = async (e: FormEvent) => {
    ...
    setError(null);
    try {
      await signup(form.email.trim(), form.password, form.org.trim());
      setSuccess(true);
    } catch (err: any) {
    ...
    <div className="relative flex min-h-screen overflow-hidden bg-[#050a09]">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-teal-500/20 rounded-full blur-[128px] animate-pulse" style={{ animationDuration: "5s" }} />
          <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-emerald-500/15 rounded-full blur-[100px] animate-pulse" style={{ animationDuration: "7s" }} />
          <div className="absolute top-1/3 left-1/3 w-[400px] h-[400px] bg-cyan-500/10 rounded-full blur-[80px] animate-pulse" style={{ animationDuration: "6s" }} />
        </div>
        ...
        <div className="relative z-10 space-y-8">
          <div>
            ...
            <p className="mt-4 text-lg text-white/60 max-w-md">
              Join leading enterprises in making AI more sustainable. Track, analyze, and reduce your ML carbon footprint.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
              ...
              <div>
                <div className="font-medium text-white">Enterprise Security</div>
                <div className="text-sm text-white/50">SOC2 compliant infrastructure</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
              ...
              <div>
                ...
                <div className="text-sm text-white/50">Track emissions as you train</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
              ...
              <div>
                ...
                <div className="text-sm text-white/50">Join 500+ sustainable teams</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center p-6 lg:p-12 bg-gradient-to-br from-[#0a1210] to-[#050a09]">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="mt-2 text-white/50">Start tracking your AI carbon footprint today</p>
          </div>

          <form onSubmit={onSubmit} className="space-y-5">
            <div className="space-y-2">
              <label className="text-sm font-medium text-white/70" htmlFor="org">
                Organization name
              </label>
              <input
                id="org"
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex h-11 items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/5 text-sm font-medium text-white transition-colors hover:bg-white/10 disabled:opacity-50"
            >
