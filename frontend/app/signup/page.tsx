    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-[#0b1b19] via-[#0c1f1d] to-[#0c1513] px-4 py-10 text-white">
      ...
      <div className="relative z-10 w-full max-w-lg space-y-8 rounded-3xl border border-white/10 bg-[#0f1716]/80 p-10 shadow-2xl backdrop-blur-xl">
        ...
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <div>
            <h1 className="text-3xl font-semibold tracking-tight">Create your GreenAI account</h1>
            <p className="mt-1 text-sm text-white/70">Get started with carbon-aware AI/ML monitoring</p>
          </div>
        </div>

        <form onSubmit={onSubmit} className="space-y-4">
          <div className="space-y-2">
            <label className="text-sm font-medium text-white/80" htmlFor="org">
              Organization name
            </label>
            <input
              id="org"
          ...
          >
            ...
            <span className="relative flex items-center gap-2">
              ...
              {loading ? "Creating account..." : success ? "Account ready" : "Create account"}
            </span>
          </button>
        </form>
