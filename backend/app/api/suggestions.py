...
@router.get("/", response_model=PaginatedResponse[SuggestionRead])
@router.get("", response_model=PaginatedResponse[SuggestionRead])
def list_suggestions(
    ...
    """List suggestions for organization with pagination."""
    # Build base query
    q = (
    ...
    suggestions = (
        q.options(joinedload(OptimizationSuggestion.project))
